...
export default function SectionPendapatanBudidayaIkan({ resdata, setResdata, flagger }) {
      ...
      <div className="p-6 antialiased">
        ...
        <div className="">
              ...
              <tr key={`${produk}-${index}`} className="hover:bg-gray-50 border-b border-gray-100">
                ...
                <td className="border-l border-gray-100 border-opacity-75 p-2 px-3">
                  <ButtonDeleteRow onClik={e => {
                    let array = [...resdata?.pendapatanBudidayaIkan]
                    array.splice(index, 1)
                    setResdata(prev => ({
                      ...prev,
                      pendapatanBudidayaIkan: array
                    }))
                    flagger()
                  }}/>
                </td>
          ...
          {formModel && <div className="border p-3 mt-2">
            ...
            <div className="pt-4 text-center text-xs">
              ...
              onClick={e => {
                setResdata(prev => ({
                  ...prev,
                  pendapatanBudidayaIkan: [ ...prev.pendapatanBudidayaIkan, formModel ]
                }))
                setFormModel(null)
                flagger()
              }}
          ...
          {!formModel && <div className="pt-5 text-center text-xs">
            <button onClick={e => { setFormModel(model.PendapatanBudidayaIkan) }}
